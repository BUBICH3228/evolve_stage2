...
declare interface CDOTA_Ability_Lua extends CDOTABaseAbility {
    ...
    OnAbilityUpgrade(upgradeAbility: CDOTABaseAbility): void;
    /**
     * Channel finished.
     */
...
declare interface CDOTA_Modifier_Lua extends CDOTA_Buff {
     ...
     * @both
     */
    OnOrder?(event: ModifierOrderEvent): void;
    /**
     * @abstract
     * @both
     */
     ...
     * @server
     */
    GetModifierConstantBaseAttackTime?(): number;
    /**
     * @abstract
     * @server
     */
    GetModifierBonusBaseAttackTimeConstant?(): number;
    /**
     * @abstract
     * @server
     */
    GetModifierBonusBaseAttackTimePercentage?(): number;
    /**
     * @abstract
     * @server
     */
    GetModifierPreSpell_CriticalStrike?(event: ModifierPreSpellCriticalStrikeEvent): number;
    /**
     * @abstract
     * @server
     */
     ...
     * @server
     */
    GetModifierLifesteal?(event: ModifierAttackEvent): number;
    /**
     * @abstract
     * @server
     */
    GetModifierSpellLifesteal?(event: ModifierInstanceEvent): number;
...
declare interface CDOTA_PlayerResource extends CBaseEntity {
    ...
    /**
     * @deprecated Use CDOTA_PlayerResource:ReplacePlayerHero instead
     */
    ReplaceHeroWith(playerId: PlayerID, heroClass: string, gold: number, xp: number): CDOTA_BaseNPC_Hero;
    /**
     * @deprecated Use CDOTA_PlayerResource:ReplacePlayerHero instead
     */
    ReplaceHeroWithNoTransfer(playerId: PlayerID, heroClass: string, gold: number, xp: number): CDOTA_BaseNPC_Hero;
...
declare interface CDOTABaseAbility extends CBaseEntity {
     ...
     * @both
     */
    GetLevelSpecialValueNoOverride(name: string, level: number, ignoreTalents?: boolean): number;
    GetManaCost(level: number): number;
...
declare interface CScriptParticleManager {
    ...
    /**
     * @deprecated Use CScriptParticleManager:DestroyAndReleaseParticle
     *
     * @both
     */
    ...
    SetParticleControlEnt(
        ...
        unit: CBaseEntity,
        particleAttach: ParticleAttachment_t,
        attachment: ParticleAttachmentLocation,
        fallbackPosition: Vector,
        includeWearables: boolean,
    ): void;
    /** @both */
    SetParticleControlFallback(particle: ParticleID, controlPoint: number, vecPosition: Vector): void;
    /**
     * @deprecated  - Use SetParticleControlTransformForward(int nFXIndex, int nPoint,
     * vForward).
     *
     * @both
     */
    ...
    /**
     * @deprecated  - Use SetParticleControlTransform(int nFXIndex, int nPoint,
    ...
    /**
     * @deprecated  - Use SetParticleControlTransform(int nFXIndex, int nPoint, Vector
 ...
 */
declare function PrecacheResource(type: PrecacheType, pathToResource: string, context: CScriptPrecacheContext): void;
