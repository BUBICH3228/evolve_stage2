...
declare interface AddNewModifierProperties
{
    duration?: number;
    [key: string]: any
}

declare interface ModifierPreSpellCriticalStrikeEvent {
...
declare interface ModifierOrderEvent extends ModifierUnitEvent {
