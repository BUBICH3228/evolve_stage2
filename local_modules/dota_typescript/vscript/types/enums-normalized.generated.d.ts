...
declare const enum ModifierFunction {
     ...
     * Method Name: `GetModifierBonusStats_Strength_Percentage`
     */
    MOUNTAIN_STATS_STRENGTH_BONUS_PERCENTAGE = 8000,
    /**
     * Method Name: `GetModifierBonusStats_Agility_Percentage`
     */
    MOUNTAIN_STATS_AGILITY_BONUS_PERCENTAGE = 8001,
    /**
     * Method Name: `GetModifierBonusStats_Intellect_Percentage`
     */
    MOUNTAIN_STATS_INTELLECT_BONUS_PERCENTAGE = 8002,
    /**
     * Method Name: `GetModifierPhysicalArmorTotal_Percentage`
     */
    MOUNTAIN_PHYSICAL_ARMOR_TOTAL_PERCENTAGE = 8003,
    /**
     * Method Name: `GetModifierConstantBaseAttackTime`
     */
    MOUNTAIN_BASE_ATTACK_TIME_CONSTANT = 8004,
    /**
     * Method Name: `GetModifierBonusBaseAttackTimeConstant`
     */
    MOUNTAIN_BASE_ATTACK_TIME_BONUS_CONSTANT = 8005,
    /**
     * Method Name: `GetModifierBonusBaseAttackTimePercentage`
     */
    MOUNTAIN_BASE_ATTACK_TIME_BONUS_PERCENTAGE = 8006,
    /**
     * Method Name: `GetModifierPreSpell_CriticalStrike`
     */
    MOUNTAIN_PRE_SPELL_CRITICAL_STRIKE = 8007,
    /**
     * Method Name: `GetModifierLifesteal`
     */
    MOUNTAIN_LIFESTEAL = 8008,
    /**
     * Method Name: `GetModifierSpellLifesteal`
     */
    MOUNTAIN_SPELL_LIFESTEAL = 8009,
    INVALID = 65535,
}
...
declare const enum ParticleAttachmentLocation {
