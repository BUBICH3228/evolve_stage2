...
export const registerModifier = (name?: string) => (modifier: new () => BaseModifier) => {
    if (name !== undefined) {
        // @ts-ignore
        modifier.name = name;
    } else {
...
export const IsDOTA_BaseNPC = (b: any): b is CDOTA_BaseNPC => {
    return (b as CDOTA_BaseNPC).GetAbsOrigin !== undefined;
};

export const IsVector = (b: any): b is Vector => {
    return (b as Vector).x !== undefined;
};

export const IsDOTA_BaseNPC_Hero = (b: any): b is CDOTA_BaseNPC_Hero => {
    return (b as CDOTA_BaseNPC_Hero).GetAgility !== undefined;
};
