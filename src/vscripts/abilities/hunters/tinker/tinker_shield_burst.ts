...
export class tinker_shield_burst extends BaseAbility {
    ...
    Precache(context: CScriptPrecacheContext): void {
        PrecacheResource(PrecacheType.PARTICLE, "particles/custom/units/heroes/hunters/tinker/tinker_shield_burst_bubble.vpcf", context);
    }
...
export class modifier_tinker_shield_burst extends BaseModifier {
    ...
    override OnCreated(): void {
        ...
        const pfx = ParticleManager.CreateParticle(
            "particles/custom/units/heroes/hunters/tinker/tinker_shield_burst_bubble.vpcf",
