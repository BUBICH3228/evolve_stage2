...
@registerAbility()
export class rattletrap_harpoon_gun extends BaseAbility {
    // Ability properties
    ...
    override OnSpellStart(): void {
        ...
        target.AddNewModifier(this.caster, this, modifier_rattletrap_harpoon_gun.name, {
...
@registerModifier()
export class modifier_rattletrap_harpoon_gun extends BaseModifier {
    // Modifier properties
    private caster: CDOTA_BaseNPC = this.GetCaster()!;
