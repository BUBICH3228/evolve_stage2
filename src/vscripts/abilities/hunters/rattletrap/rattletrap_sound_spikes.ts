...
@registerAbility()
export class rattletrap_sound_spikes extends BaseAbility {
    // Ability properties
    ...
    OnChannelFinish(interrupted: boolean): void {
        ...
        unit.AddNewModifier(this.caster, this, modifier_rattletrap_sound_spikes.name, { duration: -1 });
        this.unitData.push(unit);
    }
}

@registerModifier()
export class modifier_rattletrap_sound_spikes extends BaseModifier {
    // Modifier properties
    private caster: CDOTA_BaseNPC = this.GetCaster()!;
    private ability: rattletrap_sound_spikes = this.GetAbility()! as rattletrap_sound_spikes;
